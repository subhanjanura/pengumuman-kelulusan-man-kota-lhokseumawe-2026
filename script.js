let dataKelulusan = [];
        ...
        // Memuat file data.json saat halaman dibuka
        document.addEventListener("DOMContentLoaded", function () {
            fetch('data.json')
                ...
                .then(data => {
                    dataKelulusan = data;
                    console.log("Data berhasil dimuat. Jumlah siswa:", dataKelulusan.length);
                })
                .catch(error => {
        ...
        function cekKelulusзна() {
            ...
            if (dataKelulusan.length === 0) {
                alert("Data sedang dimuat dari server. Silakan tunggu sebentar dan coba lagi.");
                return;
            }
            ...
            setTimeout(() => {
                ...
                if (siswa) {
                    ...
                    if (siswa.status.toUpperCase() === "LULUS") {
                        ...
                        iconStatus.className = "mx-auto w-16 h-16 d-flex align-items-center justify-content-center rounded-circle bg-success fs-4 shadow-sm text-white";
                        ...
                        badgeIcon.className = "fa-solid fa-circle-exclamation me-1";
                    ...
                    iconStatus.className = "mx-auto w-16 h-16 d-flex align-items-center justify-content-center rounded-circle bg-warning fs-4 shadow-sm text-white";
